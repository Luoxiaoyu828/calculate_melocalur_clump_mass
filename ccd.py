...
class Calculate_Parameters:
    ...
    def __init__(self, record, pdf_path, co='13'):
        ...
        self.m16 = CO_Data(co_12_path=co_12_path, co_13_path=co_13_path)
    ...
    def save_fig(self, data_cube):
        ...
        width = self.record['Size_major'] / 30
        height = self.record['Size_minor'] / 30
        ...
        ellipse = Ellipse(xy=(cen[1]/2, cen[0]/2), width=width, height=height, alpha=0.5, angle=-1*angle)
